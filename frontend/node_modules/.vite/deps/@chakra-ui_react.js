...
} from "./chunk-QY2HW3JK.js";
import {
  _extends
} from "./chunk-VCGGRANA.js";
import "./chunk-X377ZMOF.js";
...
function updateMotionValuesFromProps(element, next, prev) {
  ...
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "10.17.6", `Attempting to mix Framer Motion versions ${nextValue.version} with 10.17.6 may not work as expected.`);
      }
